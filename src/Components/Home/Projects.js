  ...
  return (
      <div id="Projects">
          <Wrapper>
            ...
            <Project goto="/projects-openspace" image={openspace_lrg} name='openspace' subTitle="Social Networking Service" techs={["PHP", "JavaScript", "HTML5", "CSS3", "MySQL"]} description='A social networking web application that allows you to video chat with new groups of people.' color='3' />
            <Project goto="/projects-emerald" image={emerald_lrg} name='Emerald Backyards' subTitle="Web Development" techs={["PHP", "JavaScript", "HTML5", "CSS3", "MySQL"]} description='UX/UI design and frontend development for a landscaping company looking to gain clients.' color='4' />
